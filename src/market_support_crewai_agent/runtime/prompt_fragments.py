...
from market_support_crewai_agent.runtime.prompt_profiles import PromptStage
...
PROMPT_FRAGMENT_PACKAGE = "market_support_crewai_agent.runtime.prompts.fragments"
