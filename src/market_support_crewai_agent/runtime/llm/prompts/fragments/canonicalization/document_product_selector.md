...
Prefer one precise document. Select multiple documents only when the question truly combines company information with a specifically named product/strategy or FAQ topic. Never return more than max_documents IDs.
