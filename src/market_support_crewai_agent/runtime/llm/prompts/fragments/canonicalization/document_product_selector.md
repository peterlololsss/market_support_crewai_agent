...
For company-wide questions about Example Capital/示例 facts, team, address, overall or latest scale/AUM, or product line, choose the company-introduction candidate rather than a single strategy document unless the user clearly names that strategy.
