...
- refetch_document_context: use only for knowledge_answer when the plan is right but evidence is missing or retrieval query is off. Include refined_evidence_query.
