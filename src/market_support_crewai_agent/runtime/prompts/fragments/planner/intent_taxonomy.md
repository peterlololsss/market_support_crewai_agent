...
- Human handoff: when the user explicitly asks to continue with a human or named support person, select only an eligible typed handoff manifest for the current scene and business scope; topology alone never selects handoff.
