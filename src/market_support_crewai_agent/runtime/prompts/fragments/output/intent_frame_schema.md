...
- evidence_query is null except for knowledge_answer. For knowledge_answer, write a short semantic evidence query in normalized business terms, e.g. "示例 公司介绍 基本信息" or "示例 员工人数". Do not use it to answer from memory.
