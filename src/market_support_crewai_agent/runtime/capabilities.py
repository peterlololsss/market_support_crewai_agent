...
class CapabilitySpec:
    ...
    prompt_label: str = ""
    planner_fragment_ids: tuple[str, ...] = ()
    composer_fragment_ids: tuple[str, ...] = ()
...
CAPABILITY_REGISTRY: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec(
        ...
        composer_fragment_ids=("evidence.document_grounding",),
    ),
)
    ...
    return [
        {
            ...
            "planner_fragment_ids": list(capability.planner_fragment_ids),
            "composer_fragment_ids": list(capability.composer_fragment_ids),
        }
        for capability in CAPABILITY_REGISTRY
    ]
