...
COMPLIANCE_REASON_SPECS: tuple[ComplianceReasonSpec, ...] = (
    ComplianceReasonSpec(
        "compliant_product_request",
        "合规产品/业务请求",
        "Example Capital product/service requests, material/report requests, historical product data requests, and normal vague product questions.",
    ),
    ComplianceReasonSpec(
        "customer_service_request",
        "合规客户服务请求",
    ...
    ComplianceReasonSpec(
        "unrelated_request",
        "无关请求",
        "Requests unrelated to Example Capital products, services, market education, or customer service must be refused.",
