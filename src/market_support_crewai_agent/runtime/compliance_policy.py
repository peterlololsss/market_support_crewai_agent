...
COMPLIANCE_REASON_SPECS: tuple[ComplianceReasonSpec, ...] = (
    ...
    ComplianceReasonSpec(
        ...
        (
            ...
            "ordinary questions about whether Example Capital has a core strategy, product "
            "strategy characteristics, or historical product metrics."
        ),
        "自营盘或内部收益信息我不展开。示例各指数增强策略基于统一的 Alpha 多因子研究框架，对标不同指数获取超额。",
    ),
    ComplianceReasonSpec(
        "contract_or_restricted_document",
        "合同/受限文件",
