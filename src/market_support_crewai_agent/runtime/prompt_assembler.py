...
from market_support_crewai_agent.runtime.prompt_fragments import render_prompt_fragment
from market_support_crewai_agent.runtime.prompt_profiles import PromptProfile
...
def _template_context() -> dict[str, str]:
    return {
        ...
        "intent_frame_schema_json": _schema_json(IntentFrame),
        "reply_response_schema_json": _schema_json(ReplyResponse),
    }


def _schema_json(model_type) -> str:
    return json.dumps(
