...
def get_settings() -> settings_model.Settings:
    llm_base_url = os.getenv("YANFU_LLM_BASE_URL", "https://llm.example.com/v1")
    ...
    return settings_model.Settings(
        ...
        llm_timeout_seconds=float_env("YANFU_LLM_TIMEOUT_SECONDS", 90.0),
        llm_temperature=float_env("YANFU_LLM_TEMPERATURE", 0.1),
        llm_max_tokens=int_env("YANFU_LLM_MAX_TOKENS", 6000),
        ...
        adapter_caller_namespace=os.getenv(
            "MARKET_AGENT_ADAPTER_CALLER_NAMESPACE", "xiaoyan-wecom"
        ),
    )
