...
def get_settings() -> Settings:
    return Settings(
        ...
        llm_timeout_seconds=_float_env("MARKET_AGENT_LLM_TIMEOUT_SECONDS", 30.0),
        llm_temperature=_float_env("MARKET_AGENT_LLM_TEMPERATURE", 0.1),
        llm_max_tokens=_int_env("MARKET_AGENT_LLM_MAX_TOKENS", 6000),
