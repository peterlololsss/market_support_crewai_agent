"""Real-LLM eval over the labeled Assistant question set.
...
Examples:
    ...
    uv run --extra dev python scripts/eval_reply_assistant_question_set.py --parallel 8
    ...
    uv run --extra dev python scripts/eval_reply_assistant_question_set.py --ids 26,87,106 --show-text
"""
...
def _payload(question: Question) -> dict:
    return {
        ...
        "conversation_key": f"wecom:assistant-eval:{question.id}",
        "group_id": "assistant-eval-group",
        "sender_id": f"sender-{question.id}",
        "message": question.question,
        "is_group": True,
        "group_name": "assistant eval group",
