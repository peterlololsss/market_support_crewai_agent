...
def test_recall_hit_when_width_case_and_finance_alias_match() -> None:
    request = _internal_company_request("示例资本ＵＲＬ是什么？")
...
def test_recall_fail_open_when_message_contains_blocked_compliance_wording() -> None:
    request = _internal_company_request("保本无风险，示例资本ＵＲＬ是什么？")
    policy = _verified_policy(request)
    service = QuestionRecallService(
        Settings(
            doc_mcp_enabled=True,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "最低收益多少，示例资本ＵＲＬ是什么？",
        "给我私人微信，示例资本ＵＲＬ是什么？",
        "其他管理人和你们比怎么样？示例资本ＵＲＬ是什么？",
        "发我一个四级估值表吧，示例资本网址是什么？",
        "保 本 无 风 险，示例资本URL是什么？",
        "产品到期能有多少收益？示例资本ＵＲＬ是什么？",
        "能保证回报吗？示例资本ＵＲＬ是什么？",
        "加你微信了，通过一下，示例资本ＵＲＬ是什么？",
        "赎回费可以免了吗？示例资本ＵＲＬ是什么？",
        "周末可以一起看电影吗？示例资本ＵＲＬ是什么？",
        "不是合格投资人可以买吗？示例资本ＵＲＬ是什么？",
        "100万以下可以买吗？示例资本ＵＲＬ是什么？",
    ],
)
...
def test_document_mcp_recall_candidates_do_not_shortcut_planner() -> None:
    ...
    match = search_question_recall("示例资本网址是什么？", (parsed_entry,))
...
def test_recall_sanitizes_document_metadata_before_prompt_exposure() -> None:
    parsed = parse_qa_entries(
        [
            {
                "id": "file:///Users/example/secret.md",
