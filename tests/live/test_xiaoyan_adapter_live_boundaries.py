...
def test_live_xiaoyan_adapter_preflight_service_material_pack_option_contract() -> None:
...
def test_live_xiaoyan_adapter_report_scope_contract() -> None:
...
def test_live_xiaoyan_adapter_rejects_short_resolve_endpoint() -> None:
    base_url = live_adapter_base_url()
    api_key = os.getenv("MARKET_AGENT_LIVE_ADAPTER_API_KEY") or None
    skip_if_adapter_is_not_running(base_url, api_key)
...
def test_live_xiaoyan_adapter_rejects_raw_list_batch_payload() -> None:
    base_url = live_adapter_base_url()
    api_key = os.getenv("MARKET_AGENT_LIVE_ADAPTER_API_KEY") or None
    skip_if_adapter_is_not_running(base_url, api_key)
    body = json.dumps(
