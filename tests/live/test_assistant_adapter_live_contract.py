...
def test_live_assistant_adapter_capabilities_contract() -> None:
...
def test_live_assistant_adapter_metrics_contract() -> None:
    base_url = live_adapter_base_url()
    api_key = os.getenv("MARKET_AGENT_LIVE_ADAPTER_API_KEY") or None
    skip_if_adapter_is_not_running(base_url, api_key)
...
def test_live_assistant_adapter_batch_contract() -> None:
    base_url = live_adapter_base_url()
    api_key = os.getenv("MARKET_AGENT_LIVE_ADAPTER_API_KEY") or None
