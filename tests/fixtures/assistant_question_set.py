"""Labeled Assistant (小助手) question set.
...
_RAW: tuple[tuple[int, str, str, str], ...] = (
    ...
    (19, "有示例进取三号的表现吗？", "action", "specific fund share; adapter resolves or unable"),
    (20, "麻烦发一下示例旗舰1000的业绩表现", "action", "specific fund share; adapter resolves or unable"),
    ...
    (29, "科普专栏系列可以再发一下吗？", "action", "re-send content series; resolve or handoff"),
    ...
    (37, "示例旗舰中性1号的业绩报酬是怎么计算的", "brand_grounded", "fee calc; from FAQ"),
