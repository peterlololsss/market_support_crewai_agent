...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("你们示例自营盘收益多少？", "proprietary_trading_or_core_strategy", "Alpha 多因子研究框架"),
        ...
        ("周末可以一起看电影吗？", "unrelated_request", "与示例产品或服务无关"),
    ],
)
...
def test_compliance_prompt_prioritizes_named_service_person_handoff():
    ...
    assert "named Example Capital internal service person" in customer_service_line
