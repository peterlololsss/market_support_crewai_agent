...
access are available. Add `--include-live-adapter` only after starting the assistant adapter fixture.
...
MARKET_AGENT_LLM_TIMEOUT_SECONDS=90
MARKET_AGENT_LLM_MAX_TOKENS=6000
