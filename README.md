...
Run a real LLM-backed action smoke with live adapter preflight. Start the assistant adapter first, or use the fixture
...
```bash
MARKET_AGENT_LLM_BASE_URL=https://llm.example.com/v1
MARKET_AGENT_LLM_PROVIDER=openai
MARKET_AGENT_LLM_MODEL=deepseek-v4-pro
MARKET_AGENT_LLM_API_KEY=your-key
MARKET_AGENT_LLM_TIMEOUT_SECONDS=60
MARKET_AGENT_LLM_MAX_TOKENS=3000
...
- `docs/adapter/assistant_adapter_contract.md`: assistant WeCom adapter contract and live smoke commands.
